...
<h3>EL 에서 내장각체인 request 에 추가된 목록 객체를 추출</h3>
<pre>
...
5. \${requestScope.starMap["S5"]} = ${requestScope.starMap["S5"]}
...
<%
	...
	java.util.Map<String, String> starNameMap = (java.util.Map<String, String>)request.getAttribute("starMap");
%>

 ...
 * 리스너 클래스
 * 
 * bookShelf 타입설정, mybatis 로그 파일 위치를 
 * 초기화
 * @author PC38209
 *
 */
...
public class BookListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		System.out.println("book 어플리케이션 컨텍스트 리스너 구동");
